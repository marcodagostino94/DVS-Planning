...
insert into public.rooms (code, display_name, group_name, room_type, sort_order) values
  ...
  ('sala-11','Sala 11','CARSO 3','sala',11),
  ('sala-12','Sala 12','CARSO 3','sala',12),
  ('sala-13','Sala 13','CARSO 3','sala',13),
  ('sala-14','Sala 14','CARSO 3','sala',14),
  ('sala-15','Sala 15','CARSO 3','sala',15),
